...
BaseScene::BaseScene() {
	...
	testModel->mTransform->Translate(vec3(0.0f, 0.0f, -10.0f));
	mModels.push_back(testModel);
	...
	light1->mTransform->Translate(vec3(-2.0f, 6.0f, 0.0f));
	light1->mLightColor = vec3(1.0f, 1.0f, 1.0f);
	mLights.push_back(light1);
	auto light2 = new PointLight();
	light2->mTransform->Translate(vec3(0.0f, 6.0f, 3.0f));
	light2->mLightColor = vec3(1.0f, 0.6f, 1.0f);
